      ...
      <div class="confirm-dialog match-result-dialog">
        ...
        <form class="match-result-dialog__form">
          ...
          <label class="field">
            ...
            <input type="number" name="set1OwnScore" class="field__input" min="0" max="50" step="1" required inputmode="numeric">
          </label>
          <label class="field">
            <span class="field__label">第2セット（自チーム）</span>
            <input type="number" name="set2OwnScore" class="field__input" min="0" max="50" step="1" required inputmode="numeric">
          </label>
          <p class="match-result-dialog__error hidden" role="alert"></p>
          <div class="confirm-dialog__actions">
            <button type="button" class="btn btn--ghost" data-action="cancel">キャンセル</button>
